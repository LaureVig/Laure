...
public class TypeComposant {
	...
	public String getRequete_import() {
		return requete_import;
	}
	public void setRequete_import(String requete_import) {
		this.requete_import = requete_import;
	}
